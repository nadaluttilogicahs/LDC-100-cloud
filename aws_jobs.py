# Fonte: https://github.com/aws/aws-iot-device-sdk-python-v2/blob/main/samples/jobs.py
# Data: 03/02/2025
# Note: adattato, togliendo input e connessione mqtt 
...
def on_disconnected(disconnect_future):
    ...
    print("Jobs instance disconected.")
...
def jobInit (mqtt_connection, lthing_name):

    global jobs_thing_name
    jobs_thing_name = lthing_name
